...
var _FlaglistCheckboxGroup = _interopRequireDefault(require("../widgets/FlaglistCheckboxGroup"));
...
function (_Component) {
  ...
  function UnconnectedFlaglist() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedFlaglist).apply(this, arguments));
  }

  _createClass(UnconnectedFlaglist, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_Field.default, this.props, _react.default.createElement(_FlaglistCheckboxGroup.default, {
