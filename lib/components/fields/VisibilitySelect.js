...
var UnconnectedVisibilitySelect =
/*#__PURE__*/
function (_Component) {
  ...
  function UnconnectedVisibilitySelect(props, context) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedVisibilitySelect).call(this, props, context));
  ...
  _createClass(UnconnectedVisibilitySelect, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, dropdown ? _react.default.createElement(_Dropdown.default, {
        attr: attr,
        label: label,
        options: options,
        fullValue: this.mode,
