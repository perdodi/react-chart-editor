...
function (_Component) {
  ...
  function UnconnectedNumeric() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedNumeric).apply(this, arguments));
  }
  ...
  _createClass(UnconnectedNumeric, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Field.default, this.props, _react.default.createElement(_NumericInput.default, {
        value: fullValue,
