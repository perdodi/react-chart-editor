...
function (_Component) {
  ...
  function UnconnectedText() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedText).apply(this, arguments));
  }
  ...
  _createClass(UnconnectedText, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Field.default, this.props, _react.default.createElement(_TextInput.default, {
        value: fullValue,
