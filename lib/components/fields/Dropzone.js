...
var _Dropzone = _interopRequireDefault(require("../widgets/Dropzone"));
...
function (_Component) {
  ...
  function UnconnectedDropzone() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedDropzone).apply(this, arguments));
  }

  _createClass(UnconnectedDropzone, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_Field.default, this.props, _react.default.createElement(_Dropzone.default, {
