...
function (_Component) {
  ...
  function UnconnectedNumericOrDate() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedNumericOrDate).apply(this, arguments));
  }
  ...
  _createClass(UnconnectedNumericOrDate, [{
    ...
    value: function render() {
      ...
      return fullValueIsDate ? _react.default.createElement(_DateTimePicker.UnconnectedDateTimePicker, _extends({}, this.props, {
        placeholder: 'yyyy-mm-dd hh:mm:ss.xxx'
      })) : _react.default.createElement(_Numeric.UnconnectedNumeric, this.props);
    }
  }]);
