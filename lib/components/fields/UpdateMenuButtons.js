...
function (_Component) {
  ...
  function UpdateMenuButtons(props, context) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UpdateMenuButtons).call(this, props, context));
    _this.state = {
  ...
  _createClass(UpdateMenuButtons, [{
    ...
    value: function render() {
      return _react.default.createElement(_Field.default, null, this.renderDropdown(), _react.default.createElement(_index.TextEditor, {
