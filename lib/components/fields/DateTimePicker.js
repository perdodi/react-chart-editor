...
var _DateTimePicker = _interopRequireDefault(require("../widgets/DateTimePicker"));
...
function (_Component) {
  ...
  function UnconnectedDateTimePicker() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnconnectedDateTimePicker).apply(this, arguments));
  }

  _createClass(UnconnectedDateTimePicker, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_Field.default, this.props, _react.default.createElement(_DateTimePicker.default, {
