...
function (_Component) {
  ...
  function SingleSidebarItem() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SingleSidebarItem).apply(this, arguments));
  }

  _createClass(SingleSidebarItem, [{
    key: "render",
    value: function render() {
      return this.props.children ? _react.default.createElement("div", {
