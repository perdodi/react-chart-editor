...
function (_Component) {
  ...
  function ShapeAccordion() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ShapeAccordion).apply(this, arguments));
  }
  ...
  _createClass(ShapeAccordion, [{
    ...
    value: function render() {
      ...
      var content = shapes.length && shapes.map(function (shp, i) {
        return _react.default.createElement(ShapeFold, {
          key: i,
          shapeIndex: i,
      ...
      }, _react.default.createElement("p", null, _('Add shapes to a figure to highlight points or periods in time, thresholds, or areas of interest.')), _react.default.createElement("p", null, _('Click on the + button above to add a shape.'))));
    }
  }]);
